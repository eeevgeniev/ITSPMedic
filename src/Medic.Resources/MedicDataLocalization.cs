...
namespace Medic.Resources
{
    public class MedicDataLocalization : BaseLocalization, ILocalizationService
    {
        ...
        public const string PracticeNumber = nameof(PracticeNumber);
        ...
        public const string Chemotherapy = nameof(Chemotherapy);
        public const string Hormonetherapy = nameof(Hormonetherapy);
        public const string Targeted = nameof(Targeted);
        public const string Immunotherapy = nameof(Immunotherapy);
        public const string GrowthFactors = nameof(GrowthFactors);
        public const string Osteomodulators = nameof(Osteomodulators);
        public const string Corticosteroids = nameof(Corticosteroids);
        public const string ImmunomodulatorsImmunosuppression = nameof(ImmunomodulatorsImmunosuppression);
        public const string NonAdjuvant = nameof(NonAdjuvant);
        public const string Adjuvant = nameof(Adjuvant);
        public const string Healing = nameof(Healing);
        public const string NotChecked = nameof(NotChecked);
        public const string Minus = nameof(Minus);
        public const string Plus = nameof(Plus);
        public const string OPL = nameof(OPL);
        public const string SIMP = nameof(SIMP);
        public const string Hospital = nameof(Hospital);
        public const string ER = nameof(ER);
        public const string CKVZ = nameof(CKVZ);
        public const string KOC = nameof(KOC);
        public const string Dentist = nameof(Dentist);
        public const string SendUrgencyPlanned = nameof(SendUrgencyPlanned);
        public const string SendUrgencyEmergency = nameof(SendUrgencyEmergency);
        public const string NZOKRefuse = nameof(NZOKRefuse);
        public const string NZOKDemand = nameof(NZOKDemand);
        public const string Budget = nameof(Budget);
        public const string NZOK = nameof(NZOK);
        public const string DZIF = nameof(DZIF);
        public const string SignedOut = nameof(SignedOut);
        public const string Transferred = nameof(Transferred);
        public const string Died = nameof(Died);
        public const string RunAwayHealthcare = nameof(RunAwayHealthcare);
        public const string RunAwayNoHealthcare = nameof(RunAwayNoHealthcare);
        public const string TransferredNoHealthcare = nameof(TransferredNoHealthcare);
        public const string DiedNoHealthcare = nameof(DiedNoHealthcare);
        public const string NoParturient = nameof(NoParturient);
        public const string NZOKPayment = nameof(NZOKPayment);
        public const string Person = nameof(Person);
        public const string NotDeterminate = nameof(NotDeterminate);
        public const string Healthy = nameof(Healthy);
        public const string Better = nameof(Better);
        public const string NoChanges = nameof(NoChanges);
        public const string Worse = nameof(Worse);
        public const string DeadPatient = nameof(DeadPatient);
        public const string Yes = nameof(Yes);
        public const string No = nameof(No);
        public const string NoLine = nameof(NoLine);
        public const string FirstLine = nameof(FirstLine);
        public const string SecondLine = nameof(SecondLine);
        public const string ThirdLine = nameof(ThirdLine);
        public const string FourthLine = nameof(FourthLine);
        public const string FifthLine = nameof(FifthLine);
        public const string InitialTreatment = nameof(InitialTreatment);
        public const string FullAnswer = nameof(FullAnswer);
        public const string PartialRemission = nameof(PartialRemission);
        public const string StableDisease = nameof(StableDisease);
        public const string DiseaseProgression = nameof(DiseaseProgression);
        public const string Relapse = nameof(Relapse);
        public const string Intolerance = nameof(Intolerance);
        public const string Change = nameof(Change);
        public const string Continue = nameof(Continue);
        public const string Status = nameof(Status);
        public const string PatientSign = nameof(PatientSign);
        public const string Unassured = nameof(Unassured);
        public const string CourseNotFinished = nameof(CourseNotFinished);
        public const string CourseFinished = nameof(CourseFinished);
        public const string Hematology = nameof(Hematology);
